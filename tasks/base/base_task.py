...
class BaseTask():
    ...
    def __init__(self, cfg, enable_camera_sensors=False, is_meta=False, task_num=0):
        ...
        self.gripper_pos_history = deque(maxlen=5)
        self.another_gripper_pos_history = deque(maxlen=5)
        self.rew_list = []
        self.video_list = []
        # double check!
        ...
        self.all_actions = torch.zeros((self.num_envs, self.num_actions), device=self.device)
